...
\usepackage{xcolor}
\usepackage{multirow}
\usepackage{array} % Necessário para colunas de largura fixa
\usepackage{makecell} % Para permitir a quebra de linha dentro das células
\usepackage{float}
...
\author{\IEEEauthorblockN{1\textsuperscript{nd} Renato Augusto Tavares}
